...
class Products: NSObject {
    ...
    class func list(page: Int?, arrQueries: [RansackQuery]?, completionHandler: (result: NSDictionary?, error: NSError?) -> Void){
    ...
    class func findByPermalink(permalink: String, completionHandler: (result: NSDictionary?, error: NSError?) -> Void ) {
    ...
    class func findById(productID: Int, completionHandler: (result: NSDictionary?, error: NSError?) -> Void ) {
    ...
    class func create(dictAttributes: NSDictionary, completionHandler: (result: AnyObject?, error: NSError?) -> Void ) {
    ...
    class func delete(permalink: String, completionHandler: (result: NSDictionary?, error: NSError?) -> Void ) {
    ...
    class func update(permalink: String, attributesToUpdate: NSDictionary, completionHandler: (result: NSDictionary?, error: NSError?) -> Void ) {
    ...
    /*
    //toDo: Change RansackQuery to predicate in string mode
    ...
    */
    ...
    // Ransack has been updated to predicate in string mode
    class func search(predicate: String, completionHandler: (result: NSDictionary?, error: NSError?) -> Void ) {
        let urlQuery = "\(Definitions.SERVER_URL)\(EndpointsBase.products)?\(predicate)&token=\(Definitions.AUTH_TOKEN)"
        APICall.request(urlQuery, httpMethod: .get, data: nil, successStatusCode: 200) { (result, error) in
            completionHandler(result: result, error: error)
        }
    }
